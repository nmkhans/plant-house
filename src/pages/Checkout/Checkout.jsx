          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="hero-content flex-col lg:flex-row-reverse">
              <div className="text-center w-[300px] lg:w-[500px] m-auto bg-base-300 rounded shadow p-7">
                <div className="mb-3">
                  <h3 className="text-xl text-base-200 font-semibold">
                    Your order
                  </h3>
                </div>
                <div className="mx-auto ">
                  {Object.keys(cart).map((keys) => (
                    <CartItem keys={keys} item={cart[keys]} />
                  ))}
                </div>
                ...
                <div>
                  ...
                  <div className="text-left ml-14 mt-5 font-semibold flex items-center justify-evenly text-base-200">
                    <span>Shipping:</span>
                    <span>{shipping} Taka</span>
                  </div>
                  <div className="divider"></div>
                  <div className="text-left ml-14 font-semibold flex items-center justify-evenly text-base-200">
                    <span>Total:</span>
                    <span>{subTotal + shipping} Taka</span>
                  </div>
                </div>
                <div className="mt-5">
                  <h3 className="text-lg text-base-200 font-semibold mb-2">
                  ...
                  <div className="form-control mb-2">
                    <label onClick={() => setPaymentMethod("")} className="flex items-center justify-center cursor-pointer">
                      ...
                      />
                      <span className="label-text font-semibold pl-2">COD</span>
                    </label>
                  </div>
                ...
                <div className="mt-5">
                  <p className="label-text">
                    Your personal data will be used for processing your order.
                ...
                <div className="card-body">
                  ...
                  <div className="form-control">
                    ...
                    <textarea
                      ...
                      className="input input-bordered h-[80px] p-5"
                      {...register("address", {
                        required: {
                          value: true,
