...
const Register = () => {
    ...
    const onSubmit = async (data) => {
        if (data.password === data.cPassword) {
            ...
            const { data: { url: imageUrl } } = await uploadImage(formData)
                ...
                <div className="min-h-screen">
                    <div className="hero-content flex-col lg:flex-row">
                        <div className="text-center mr-5">
                            <img className="w-[300px] lg:w-[500px] m-auto" src={registerImg} alt="register image" />
                        </div>
                        <div className="card flex-shrink-0 w-full max-w-lg shadow-2xl bg-base-100">
                            <div className="card-body">
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    <h3 className="text-xl text-center text-base-200 font-semibold">Register</h3>
                                    ...
                                    <div className="form-control">
                                        ...
                                        <input
                                            type="number" placeholder="Enter number" className="input input-bordered"
                                            {...register("phone", {
                                                required: {
                                                    value: true,
                                    ...
                                    <div className="form-control">
                                        ...
                                        />
                                        <p className="text-sm text-red-600 mt-2 ml-3">{errors?.image?.type === 'required' && errors?.image?.message}</p>
                                    </div>
                                    <div className="form-control">
                                        <label className="label">
                                    ...
                                    <div className="form-control">
                                        ...
                                        />
                                        <p className="text-sm text-red-600 mt-2 ml-3">{errors?.cPassword?.type === 'required' && errors?.cPassword?.message}</p>
